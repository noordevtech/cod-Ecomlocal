      ...
      <div class="m-portlet__head-tools">
         <div class="row align-items-center">
					...
					<div class="col-lg-6 m--align-right">
						...
						<span class="m--margin-left-10">or <a href="#" class="m-link m--font-bold delete-link">Delete</a></span>
					</div>
				</div>
      </div>
   </div>
                              ...
                              <td>
                                 <div class="dropdown m-dropdown--inline dropup">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                       ...
                                       @endif
                                        <a class="dropdown-item" href="/order/delete/{{ $order->order_id }}"><i class="la la-remove"></i> Delete</a>
